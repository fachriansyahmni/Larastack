              ...
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                  <figure class="figure text-center">
                    @if (!empty($data->photo))
                    <img src="{{ asset('img/profile/'.$data->photo) }}" class="rounded shadow" alt="Img User" width="200px">
                    @else
                    <img src="{{ asset('img/profile/nophoto.jpg')}}" class="rounded shadow" alt="Img User" width="200px">
                    @endif
                  </figure>
